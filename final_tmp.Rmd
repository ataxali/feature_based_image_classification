...
\begin{center}
\includegraphics[width=0.9\linewidth]{Image/nn_low_classification.jpg}
\end{center}

\begin{center}
\includegraphics[width=0.9\linewidth]{Image/nn_high_classification.jpg}
\end{center}
...
\begin{center}
\includegraphics[width=0.9\linewidth]{Image/BoF_classification.jpg}
\end{center}

**TODO: BoF with HOG, high-/low- classification matrix** 

\begin{center}
\includegraphics[width=0.9\linewidth]{Image/tbl_BoF_sift_HOG.PNG}
\end{center}
